...
$repo_backup = "budget-pdq-deploy","cn2od-backup","code-dump","credential-manager","dns-blackhole","git-backup","mikrotik-tools","scada-backup","scheduled-task","sdmyers-rainbow-rename","smartvu-map","vm-backup-prune"
